...
public class list_menu extends javax.swing.JFrame {
    ...
    private void btn_pilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pilihActionPerformed
        ...
        String id_menu = tabel_list.getValueAt(i, 0).toString();
        String nama_menu = tabel_list.getValueAt(i, 1).toString();
        String harga_menu = tabel_list.getValueAt(i, 3).toString();
        
        
        transaksi.txt_idmenu.setText(id_menu);
        transaksi.txt_namamenu.setText(nama_menu);
        transaksi.txt_hargamenu.setText(harga_menu);
